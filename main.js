 ...
 * 
 * @param {IShellUI} shellUI - The shell UI object that was created.
 */
function OnNewShellUI( shellUI ) {
    /// <summary>Executed by the UIX when a ShellUI module is started.</summary>
    /// <param name="shellUI" type="IShellUI">The shell UI object which was created.</param>
 ...
 * 
 * @param {IShellFrame} shellFrame - The shell frame object that was created.
 */
function handleNewShellFrame( shellFrame ) {
    
    /// <summary>Handles the OnNewNormalShellFrame event for an IShellUI.</summary>
    /// <param name="shellFrame" type="IShellFrame">The shell frame object which was created.</param>
 ...
 * 
 * @param {IShellFrame} shellFrame - The shell frame to handle
 * @returns {() => void} A function which handles the Started event.
 */
